export const MastercardLogo = ({ size = 152 }) => {
  return (
    <svg
    ...
    >
      <g>
        {/* Changed style="fill:none" to style={{ fill: 'none' }} */}
        <rect y="0" style={{ fill: 'none' }} width="152.4" height="108" />
        <g>
          {/* Use camelCase for CSS properties if needed, e.g., backgroundColor */}
          <rect x="60.4" y="25.7" style={{ fill: '#FF5F00' }} width="31.5" height="56.6" />
          <path
            style={{ fill: '#EB001B' }}
